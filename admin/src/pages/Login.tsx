        ...
        <Card className='w-full bg-white/95 backdrop-blur-sm shadow-xl border border-gray-200'>
          ...
          <CardContent>
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-6'>
               ...
               <div>
                <Button type='submit' disabled={isLoading} className='w-full bg-indigo-600 hover:bg-indigo-700 hoverEffect text-white font-semibold py-2 rounded-lg'>
                   {isLoading ? (
          ...
          <CardFooter className='justify-center'>
            <p className='text-sm  text-gray-500'>
              ...
              className='text-indigo-600 hover:text-indigo-800 hoverEffect hover:underline'>Sign up</Link></p>
          </CardFooter>
        </Card>
      </motion.div>
    </div>
