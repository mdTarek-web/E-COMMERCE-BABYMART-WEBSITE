        ...
        <Card className='w-full bg-white/95 backdrop-blur-sm shadow-xl border border-gray-200'>
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-3'>
                 <FormField control={form.control} name='name' render={({field})=>( 
                  <FormItem >
                    ...
                    <FormControl>
                       <Input placeholder='Enter you name' type='text' disabled={isLoading}
                ...
                <FormField control={form.control} name='role' render={()=>( 
                  <FormItem>
                    ...
                    <FormControl>
                       <Input placeholder='user' type='text' disabled={isLoading}
          ...
          <CardFooter className='justify-center'>
            <p className='text-sm  text-gray-500'>
              ...
              className='text-indigo-600 hover:text-indigo-800 hoverEffect hover:underline'>Sign in</Link></p>
          </CardFooter>
        </Card>
      </motion.div>
    </div>
